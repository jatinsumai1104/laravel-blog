        ...
        <form action="/blog/create" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded" id="" rows="3" name="short_description"
                          placeholder="Max 255 characers allowed">{{old("short_description")}}</textarea>
                @error('short_description')
                <p class="form-text text-danger">{{implode(" ", $errors->get('short_description'))}}</p>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded html-content" id="" name="content">{{old('content')}}</textarea>
                @error('content')
